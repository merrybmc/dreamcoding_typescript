{
  ...
  const maker4: CommercialCoffeeMaker = CoffeeMachine.makeMachine(32);
  maker4.fillCoffeeBeans(50);
  maker4.makeCoffee(2);
  maker4.clean();
  ...
  class ProBarista {
    ...
    makeCoffee() {
      const beansAdd = this.machine.fillCoffeeBeans(40);
      const coffee = this.machine.makeCoffee(2);
      const clean = this.machine.clean();
    }
  }
